...
class ApiUtils {
    ...
    static func getJsonString(from response: Moya.Response) -> String? {
        ...
        do {
            ...
            Log.shared.log(error, as: .error, from: .apiResponse)
            return nil
        }
    ...
    static func print(request: URLRequest) {
        ...
        Log.shared.log(info, as: .info, from: .apiRequest)
    }
    ...
    static func printResponse(_ request: URLRequest?, _ response: HTTPURLResponse?, _ data: Data?, _ error: NSError?) {
        ...
        Log.shared.log(info, as: .info, from: .apiResponse)
    }
...
extension Encodable {
    ...
    func encodeToJson() -> String? {
        ...
        do {
            ...
            Log.shared.log(error, as: .error, from: .apiRequest)
            return nil
        }
